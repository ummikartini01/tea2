...
<head>
    ...
    <title>Profile Routes Test - Teazy</title>
    <style>
...
<body>
    <div class='container'>
        <h1>🍵 Profile Routes & Form Test</h1>";

echo "<div class='grid'>";
echo "<div class='section'>";
echo "<h2>🔍 Profile Routes Test:</h2>";
...
$testRoutes = [
    ...
    'user.profile.update' => 'User Profile Update (alias)'
];
...
if (\Illuminate\Support\Facades\Auth::check()) {
    ...
    echo "<div class='info'>";
    echo "<a href='" . route('profile') . "' class='btn'>👤 Profile</a>";
    echo "<a href='" . route('profile.edit') . "' class='btn'>✏️ Edit Profile</a>";
    echo "<a href='/dashboard' class='btn'>🏠 Dashboard</a>";
    echo "<a href='/test-profile-routes.php' class='btn'>🔄 Refresh Test</a>";
    echo "</div>";
